...
public class PointToNorthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_point_to_north);
        ...
        ivCompassImage = findViewById(R.id.img_ptn_compass);
        tvConnectionState = findViewById(R.id.tv_connection_state);
        tvOrientationAngle = findViewById(R.id.tv_ptn_Orientation);
    }
    ...
    public void onClickptnStop(View view) {

        myBleManager.sendMessage("<S>");
        myRunningActivityManager.setToNoActiveMode();
        Intent openMainMenuActivity = new Intent(this, MainMenu.class);
